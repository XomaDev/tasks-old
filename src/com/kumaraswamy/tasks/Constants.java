...
public class Constants {
    ...
    public static final String COMPONENTS_PREFIX = "com.google.appinventor.components.runtime.";
    ...
    protected static final String[] companionPackages = new String[]{
            "edu.mit.appinventor.aicompanion3",
            "io.makeroid.companion"};
}
